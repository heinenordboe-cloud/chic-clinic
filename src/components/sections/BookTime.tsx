  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          <div
            className="pointer-events-none absolute -right-24 -top-24 z-0 h-64 w-64 rounded-full bg-gold-500/10 blur-3xl"
            aria-hidden
          />
          <div
          ...
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            <BlurFade inView inViewMargin="-80px" delay={0}>
              <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-gold-600 text-white shadow-md shadow-gold-900/15">
