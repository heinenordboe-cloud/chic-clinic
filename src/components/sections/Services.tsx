      ...
      <div className="mx-auto max-w-6xl px-4">
        <BlurFade inView inViewMargin="-80px" delay={0}>
          <div className="mb-6 text-center">
            <h2 className="text-balance font-display text-3xl font-semibold tracking-tight text-stone-900 sm:text-4xl">
              Tjenester og priser
            </h2>
          </div>
        </BlurFade>
        <BlurFade inView inViewMargin="-80px" delay={0.25}>
          <p className="mx-auto mb-4 max-w-2xl text-balance text-center font-body text-stone-600">
            Hos{" "}
            <span className="font-medium text-stone-800">
              {siteConfig.owner.fullName}
            </span>{" "}
            får du profesjonelle behandlinger i rolige omgivelser — med trygghet
            og dialog hele veien.
          </p>
          <p className="mx-auto mb-16 max-w-2xl text-balance text-center font-body text-sm text-stone-500">
